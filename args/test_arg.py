...
def args_parser():
    ...
    parser.add_argument('--dataset', type=str, default='wiki_text2', help="name of dataset")
    ...
    parser.add_argument('--logging_path', type=str, default='./logging/transformer_wikitext2_avg', help='logging path')
