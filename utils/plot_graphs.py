...
if __name__ == '__main__':
    plot_two_keys('round', 'train_acc', {
        ...
        'fedcomp': '../logging/fedcomp_cifar10_resnet18_interval=1_no_ec',
        'fedcomp+rescale+clip': '../logging/fedcomp_cifar10_resnet18_interval=3_clip_autoscale',
