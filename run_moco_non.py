from utils.moco_simulator import Simulator
import argparse
...
def args_parser():
    ...
    parser.add_argument('--use_global_queue', type=bool, default=False, help='global pool')

    # dataset
    parser.add_argument('--dataset', type=str, default='cifar10', help="name of dataset")
    parser.add_argument('--data_path', type=str, default='./data', help='data path')
    parser.add_argument('--resize', type=int, default=-1, help='resize the input image, -1 means no resizing')
    parser.add_argument('--kdim', type=int, default=128, help='projected feature dimension')

    # logging and evaluation
    parser.add_argument('--test_freq', type=int, default=5, help="rounds of testing")
    parser.add_argument('--logging_path', type=str, default='./logging/C10_moco_non', help='logging path')
